#!/usr/bin/python
#
# data labels form of Cityscapes labels
#
...
labels = [
    ...
    Label('cub',  2,        2, 'flat', 1, False, False, (81, 0, 81)),
    Label('mycar',  3,        3, 'flat', 1, False, False, (127, 50, 127)),
    Label ('void', 4,       4, 'flat', 1,False, False, (0, 0, 0)),
]
